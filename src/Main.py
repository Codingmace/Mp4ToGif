...
print("\n")
startDateCamera = str(input("What is the START date for the most recent time-lapse video files?\n(Please enter in YYYYMMDD format): \n"))
print("\n")
endDateCamera = str(input("What is the END date for the most recent time-lapse video files?\n(Please enter in YYYYMMDD format): \n"))
